...
<div class="content content-category">
  <h1 class="section-title2">Categories</h1>
    <!-- <div class="table-list"> -->
          <ul class="topic-list">
            <?php foreach ($topics as $key => $topic): ?>
              <li><h3><a href="<?php echo BASE_URL . '/index.php?t_id=' . $topic['id'] . '&name=' . $topic['name'] ?>" class="btn btn-category"><?php echo $topic['name']; ?></a></h3></li>
            <?php endforeach; ?>
          </ul>
        ...
        <?php foreach ($posts as $post): ?>
          <div class="post clearfix">
            ...
            <div class="post-preview">
              ...
              <h4><a href="single.php?id=<?php echo $post['id']; ?>" class="btn"><?php echo 'Read More'; ?></a></h4>
            </div>
          </div>
        <?php endforeach; ?>
